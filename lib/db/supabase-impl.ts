...
const toProfile = (r: any): Profile => ({
  ...
  website: r.website ?? undefined, industry: r.industry ?? undefined,
  monthlySpend: r.monthly_spend ?? undefined,
  campaignExperience: r.campaign_experience ?? undefined,
...
const fromProfile = (p: Profile) => ({
  ...
  website: p.website ?? null, industry: p.industry ?? null,
  monthly_spend: p.monthlySpend ?? null,
  campaign_experience: p.campaignExperience ?? null,
...
const toCampaign = (r: any): Campaign => ({
  ...
  retainerClipperPoisha: r.retainer_clipper_poisha ?? undefined,
  retainerAgencyPoisha: r.retainer_agency_poisha ?? undefined,
  retainerVideos: r.retainer_videos ?? undefined,
  retainerSlots: r.retainer_slots ?? undefined,
...
const fromCampaign = (c: Campaign) => ({
  ...
  retainer_clipper_poisha: c.retainerClipperPoisha ?? null,
  retainer_agency_poisha: c.retainerAgencyPoisha ?? null,
  retainer_videos: c.retainerVideos ?? null, retainer_slots: c.retainerSlots ?? null,
